...
function PlannerApp() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden justify-center items-stretch gap-7 px-8 pt-10 pb-12 bg-bgPrimary max-[1200px]:gap-3 max-[1200px]:px-6 max-[1200px]:pt-6 max-[1200px]:pb-8 max-[900px]:h-auto max-[900px]:min-h-screen max-[900px]:overflow-visible max-[900px]:flex-col max-[900px]:items-center max-[900px]:gap-5 max-[900px]:px-5 max-[900px]:pt-7 max-[900px]:pb-10">
